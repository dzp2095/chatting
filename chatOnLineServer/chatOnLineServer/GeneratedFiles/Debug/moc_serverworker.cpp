...
const QMetaObject ServerWorker::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_ServerWorker.data,
      qt_meta_data_ServerWorker,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ServerWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ServerWorker.stringdata0))
        return static_cast<void*>(const_cast< ServerWorker*>(this));
