...
QT_MOC_LITERAL(1, 12, 13), // "finish_signal"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "loginThread\0finish_signal\0"
};
...
void loginThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->finish_signal((*reinterpret_cast< const int(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (loginThread::*_t)(const int , const QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&loginThread::finish_signal)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void loginThread::finish_signal(const int _t1, const QString _t2)
{
